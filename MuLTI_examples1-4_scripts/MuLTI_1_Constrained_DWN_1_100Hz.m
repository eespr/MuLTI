...
freq = data(1:39,1);% set frequency
data = data(1:39,2); % set observed data
nd =numel(data); % nd is the number of data points

%determine fitting error of picking dispersion curve in m/s
fitting_error = half_width(1:39,2); % set fitting error to half width of waveform's dispersion image
...
save('1.Constrained_DWN_1_100Hz.mat') 
