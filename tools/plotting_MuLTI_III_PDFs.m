...
hold on
plot( freq, gpdc_p(freq(1,1):2:freq(end,1),1:3),'r','linewidth',4);
hold on;
plot( freq, data, '*g','markersize',8);
hold on;
plot( freq, data+fitting_error,'--g','markersize',8);
hold on;
plot( freq, data-fitting_error, '--g','markersize',8);
% Create ylabel
...
%PDF FM
figure
contourf(freq_edge,vs_edge,CI_density_FMN,1000,'edgecolor','none') %pdf plot
hold on
plot( freq, gpdc_p(freq(1,1):2:freq(end,1),1:3),'r','linewidth',4);
hold on;
plot( freq, data, '*g','markersize',8);
hold on;
plot( freq, data+fitting_error,'--g','linewidth',2);
hold on;
plot( freq, data-fitting_error, '--g','linewidth',2);
% Create ylabel
ylabel('Phase velocity (m/s)');
