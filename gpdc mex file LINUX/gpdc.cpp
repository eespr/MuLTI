...
void processModel(int nLayers,
  ...
  /* default values: */
  int nRayleigh      = 5;      /* geopsy default : 1    */
  int nLove          = 0;
  bool groupSlowness = false;
  int nSamples       = 150;    /* geopsy default : 100  */
  double minRange    = 1.0;    /* geopsy default : 0.2  */
  double maxRange    = 150.0;  /* geopsy default : 20.0 */
  int vNSamples      = 100;
  ...
  */
  ...
  /*
    samplingType:
      ...
      8 : Function
  */
  SamplingOption samplingType = LinearScale; /* geopsy default : LogScale */
